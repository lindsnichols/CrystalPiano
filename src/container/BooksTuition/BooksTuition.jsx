...
const BooksTuition = () => (
  ...
  >
    <div className="app__tuition-content app__wrapper_info soft__background">
      <h7 className="headtext__cormorant">Tuition & Books</h7>
      ...
      <div>
        ...
        <p className="p__opensans">
          For your convenience, Crystal purchases lesson materials for each
          ...
          will notify you when the ourchased books exceed this amount, and an
